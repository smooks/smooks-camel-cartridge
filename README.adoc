...
CAUTION: The Camel cartridge is deprecated. It is superseded by the https://camel.apache.org/components/next/smooks-component.html[Camel Smooks Component] and the https://camel.apache.org/components/next/dataformats/smooks-dataformat.html[Camel Smooks Data Format].
